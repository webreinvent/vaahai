...
def run_showcase():
    ...
    print_header("Rich Formatting Showcase", "Demonstrating console output capabilities")
...
def showcase_advanced():
    ...
    print_key_value("Description", "A multi AI agent CLI tool using Microsoft Autogen Framework")
...
def showcase_all():
    ...
    print_info("These formatting utilities can be used throughout the VaahAI CLI for consistent and visually appealing output.")
